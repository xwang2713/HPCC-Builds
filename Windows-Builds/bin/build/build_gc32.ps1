...
@"
   cmake  -G "Visual Studio 14 2015" -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWITH_SYSTEM_BOOST=1 `
		  -DBOOST_INCLUDEDIR=${EXTERNALS2_DIRECTORY}/boost/1.60.0 `
		  -DBOOST_LIBRARYDIR=${EXTERNALS2_DIRECTORY}/boost/1.60.0/lib32-msvc-14.0 `
		  ...
		  -DFREETYPE_LIBRARY:FILEPATH=${EXTERNALS2_DIRECTORY}/freetype2/2.4.8/objs/win32/vc2015/freetype248MT.lib `
...
$cmd = "cmake -G 'Visual Studio 14 2015' -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWITH_SYSTEM_BOOST=1 " `
              + "-DBOOST_INCLUDEDIR=${EXTERNALS2_DIRECTORY}/boost/1.60.0 " `
			  + "-DBOOST_LIBRARYDIR=${EXTERNALS2_DIRECTORY}/boost/1.60.0/lib32-msvc-14.0 " `
			  + "-DGRAPHVIZSRC_DIR=${EXTERNALS2_DIRECTORY}/graphviz/2.26.3 " `
			  + "-DEXPAT_INCLUDE_DIR=${EXTERNALS2_DIRECTORY}/expat/2.0.1 " `
