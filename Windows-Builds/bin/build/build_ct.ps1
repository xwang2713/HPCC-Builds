...
@"
  cmake -G \"Visual Studio 12 2013\" -DCMAKE_BUILD_TYPE=${cmake_build_type} -DUSE_NATIVE_LIBRARIES=OFF `
		...
		-DEXTERNALS_DIRECTORY=${EXTERNALS_DIRECTORY} -DUSE_APR=OFF -DUSE_MYSQL=OFF -DUSE_REDIS=OFF `
...
$cmd = "cmake -G 'Visual Studio 12 2013' -DCMAKE_BUILD_TYPE=$cmake_build_type -DUSE_NATIVE_LIBRARIES=OFF " `
       + "-DCHECK_GIT_TAG=0 -DCLIENTTOOLS_ONLY=ON -DUSE_PYTHON=OFF -DUSE_V8=OFF -DUSE_JNI=OFF -DUSE_RINSIDE=OFF " `
       + "-DSIGN_DIRECTORY=${SIGN_DIRECTORY} -DEXTERNALS_DIRECTORY=${EXTERNALS_DIRECTORY} -DUSE_APR=OFF -DUSE_REDIS=OFF " `
