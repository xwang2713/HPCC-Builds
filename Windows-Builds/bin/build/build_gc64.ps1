...
@"
   cmake  -G "Visual Studio 10 Win64" -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWITH_SYSTEM_BOOST=1 
		  -DBOOST_INCLUDEDIR=${EXTERNALS2_DIRECTORY}/Boost/include/boost-1_46_1 
		  -DBOOST_LIBRARYDIR=${EXTERNALS2_DIRECTORY}/Boost/lib64 
		  ...
		  -DFREETYPE_LIBRARY:FILEPATH=${EXTERNALS2_DIRECTORY}/ft248/freetype-2.4.8/objs/win64/vc2010/freetype248MT.lib 
		  -DFB_PROJECTS_DIR:PATH=../GraphControl -DAGGSRC_DIR:PATH=../../agg ../../FireBreath" 

"@

$cmd = "cmake -G 'Visual Studio 10 Win64' -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWITH_SYSTEM_BOOST=1 " `
              + "-DBOOST_INCLUDEDIR=${EXTERNALS2_DIRECTORY}/Boost/include/boost-1_46_1 " `
			  + "-DBOOST_LIBRARYDIR=${EXTERNALS2_DIRECTORY}/Boost/lib64 " `
			  + "-DGRAPHVIZSRC_DIR=${EXTERNALS2_DIRECTORY}/graphviz-2.26.3 " `
			  + "-DEXPAT_INCLUDE_DIR=${EXTERNALS2_DIRECTORY}/expat-2.0.1 " `
